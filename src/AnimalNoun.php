...
class AnimalNoun extends AbstractList
{
    protected function getList()
    {
        return [
            'Aardvark', 'Addax', 'Albatross', 'Alligator', 'Alpaca', 'Anaconda', 'Angelfish', 'Anteater', 'Antelope', 'Ant', 'Ape', 'Armadillo',
            'Baboon', 'Badger', 'Barracuda', 'Bat', 'Batfish', 'Bear', 'Beaver', 'Bee', 'Beetle', 'Bird', 'Bison', 'Boar', 'Booby', 'Buffalo', 'Bug', 'Butterfly', 'Buzzard',
            ...
            'Gannet', 'Gaur', 'Gazelle', 'Gecko', 'Gemsbok', 'Gentoo', 'Gerbil', 'Gerenuk', 'Gharial', 'Gibbon', 'Giraffe', 'Gnat', 'Gnu', 'Goat', 'Goldfinch', 'Goosander', 'Goose', 'Gorilla', 'Goshawk', 'Grasshopper', 'Grebe', 'Grivet', 'Grouse', 'Guanaco', 'Gull',
            'Hamerkop', 'Hamster', 'Hare', 'Hawk', 'Hedgehog', 'Heron', 'Herring', 'Hippopotamus', 'Hoopoe', 'Hornet', 'Horse', 'Hummingbird', 'Hyena',
            'Ibex', 'Ibis', 'Iguana', 'Impala',
            'Jackal', 'Jaguar', 'Jay', 'Jellyfish',
            'Kangaroo', 'Katipo', 'Kea', 'Kestrel', 'Kingfisher', 'Kinkajou', 'Kitten', 'Koala', 'Kookaburra', 'Kouprey', 'Kudu',
            'Ladybird', 'Lapwing', 'Lark', 'Lemur', 'Leopard', 'Lion', 'Lizard', 'Llama', 'Lobster', 'Locust', 'Loris', 'Louse', 'Lynx', 'Lyrebird',
            ...
            'Panda', 'Panther', 'Parrot', 'Partridge', 'Peacock', 'Peafowl', 'Peccary', 'Pelican', 'Penguin', 'Petrel', 'Pheasant', 'Pig', 'Pigeon', 'Pintail', 'Piranha', 'Platypus', 'Plover', 'Polecat', 'Pollan', 'Pony', 'Porcupine', 'Porpoise', 'Puffin', 'Puma', 'Pygmy',
